...
//
//public class Square {
//    // GPU 를 이용하여 고속 계산하여 화면처리하기 위한 코드
//    String vertexShaderCode =
//            "uniform mat4 uMVPMatrix;" + // 4 x 4 형태의 상수로 지정
//            "atrribute vec4 vPosition;" +  // vec4 -> 3차원 좌표
//            "void main () {" +
//            "gl_Position = uMVPMatrix * vPosition ;" +
...
//    };
//
//    float [] color = {1.0f, 0.5f, 0.3f, 1.0f}; // 빨강에 가까움
//
//    // 그리는 순서
...
//
//        // 정렬
//        // 하는이유 : (little Endian, Big Endian 을 알아야한다!) 장비에 따라서 오더내리기 위해서
//        bb.order(ByteOrder.nativeOrder());
//
//        vertexBuffer = bb.asFloatBuffer();
//        vertexBuffer.put(squareCoords);
...
//        GLES20.glAttachShader(mProgram, fragmentShader);
//
//        GLES20.glLinkProgram(mProgram); // 도형 렌더링 계산식 정보
//    }
//
//    int mPositionHandle, mColorHandle, mMVPMatrixHandle;
//
