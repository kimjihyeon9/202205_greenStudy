...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 위도 : 37.498085435791786, 경도 : 127.02800027507125 강남역
        // 위도 : 37.50480750754078, 경도 : 127.02549203487885 신논현역
        mPlaces.add(new MyPlace("강남역", 37.498085435791786, 127.02800027507125, Color.RED));
        mPlaces.add(new MyPlace("신논현역", 37.50480750754078, 127.02549203487885, Color.BLUE));
        ...
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.CAMERA)
            ...
            ActivityCompat.requestPermissions(
                    ...
                    new String[]{
                            ...
                            Manifest.permission.ACCESS_FINE_LOCATION, // 위치정보 쓸거야
                            Manifest.permission.ACCESS_COARSE_LOCATION // 위치정보 쓸거야
                    },
                    0
            );
        }
